...
<body class="antialiased">
    <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 selection:bg-red-500 selection:text-white">
        <!---------------------------Barra de Opciones------------------------->
        @if (Route::has('login'))
        <div class="sm:fixed sm:top-0 sm:center-0 p-6 text-center z-10 fondo-negro">
            @auth
            <a href="{{ url('/dashboard') }}"
                class="font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Dashboard</a>
            @else
            <a href=""
                class="p-6 font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">GRUPOS</a>
            <a href=""
                class="p-6 font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">EQUIPOS</a>
            <a href=""
                class="p-6 font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">RESULTADO</a>
            <a href="{{ route('login') }}"
                class="p-6 font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">INICIAR
                SESIÓN</a>
        ...
        @endif
            <!-- Imagen -->
            <div class="relative sm:center-0">
                <img src="{{ asset('Imagenes/intro.jpeg') }}" alt="Descripción">
            </div>
            <!---TABLAS--->
